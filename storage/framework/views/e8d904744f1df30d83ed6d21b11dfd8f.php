   ...
   <!--  <div class="mode_switcher my_switcher">
    ...
    <div class="herobannerarea herobannerarea__box herobannerarea__single__instructor">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                    <div class="herobannerarea__content__wraper">
                        ...
                        <div class="hreobannerarea__button">
                            <a class="herobannerarea__button__1" href="<?php echo e(url('contact')); ?>" >Book Free Assessment</a>
                        </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                    <div class="aboutarea__img__inner text-center">
                        <div class="aboutarea__img" data-tilt>
                            <img loading="lazy"  class="w-75" src="<?php echo e(asset('assets/img/herobanner/bg3.png')); ?>" alt="aboutimg">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="herobannerarea__icon">
            <img loading="lazy"  class="hero__icon__1" src="<?php echo e(asset('assets/img/register/register__2.png')); ?>" alt="photo">
            <img loading="lazy"  class="hero__icon__2" src="<?php echo e(asset('assets/img/herobanner/herobanner__6.png')); ?>" alt="photo">
            <img loading="lazy"  class="hero__icon__3" src="<?php echo e(asset('assets/img/herobanner/herobanner__7.png')); ?>" alt="photo">
            <img loading="lazy"  class="hero__icon__4" src="<?php echo e(asset('assets/img/herobanner/herobanner__7.png')); ?>" alt="photo">
        </div>
    </div>
    ...
    <div class="instructor sp_top_70 sp_bottom_10" id="aboutus">
        <div class="container">
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="instructor__sidebar" data-tilt>
                        <div class="instructor__sidebar__img" data-aos="fade-up">
                            <img loading="lazy" src="<?php echo e(asset('assets/img/about/about1.png')); ?>" alt="Instructor">
                            <!-- <div class="instructor__sidebar__small__img">
                                <img loading="lazy" src="<?php echo e(asset('assets/img/about/about_4.png')); ?>"  alt="img">
                            </div> -->
                        </div>
                    </div>
                </div>
                            ...
                            <div class="instructor__content__wraper" data-aos="fade-up">
                                ...
                                <div class="aboutarea__5__small__icon__wraper">
                                    <div class="aboutarea__5__small__icon">
                                        <img loading="lazy"  src="<?php echo e(asset('assets/img/about/about_15.png')); ?>"  alt="about">

                                    </div>
                                    <div class="aboutarea__small__heading">
                                        <span>10+ Years Experience </span>In Online Learning
                                    </div>

                                </div>
                                <p>We are dedicated to providing an easy and effective learning platform for students, parents, and educators. Our Learning Management System helps manage courses, track progress, and support learning in a simple and organized way.

                                Our goal is to make learning more accessible, engaging, and efficient through modern digital tools. We aim to create a supportive environment where every learner can grow and succeed.</p>

                                <div class="aboutarea__bottom__button__5">
                                <a class="default__button" href="<?php echo e(url('about')); ?>"> More About
            ...
            <div class="row ">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class ">
                    <div class="gridarea__wraper">
                        <div class="gridarea__img"><img loading="lazy"  src="<?php echo e(asset('assets/img/contact/email.jpg')); ?>" alt="grid">
                        ...
                        <div class="gridarea__content">
                            ...
                            <div class="text-center">
                                ...
                                <a href="<?php echo e(url('contact')); ?>"><button class="default__button ">Get in Touch
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class ">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img"><img loading="lazy"  src="<?php echo e(asset('assets/img/contact/call.jpg')); ?>" alt="grid">
                                <div class="gridarea__small__button gridarea__small__button__1">
                            ...
                            <div class="gridarea__content">
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="<?php echo e(url('contact')); ?>"><button class="default__button ">Schedule Call
                                        <i class="icofont-long-arrow-right"></i></button></a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class ">
                            <div class="gridarea__wraper">
                                <div class="gridarea__img"><img loading="lazy"  src="<?php echo e(asset('assets/img/contact/confirm.jpg')); ?>" alt="grid">
                                    <div class="gridarea__small__button gridarea__small__button__1">
                                ...
                                <div class="gridarea__content">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a href="<?php echo e(url('contact')); ?>"><button class="default__button ">Start Tutoring
                                            <i class="icofont-long-arrow-right"></i></button></a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 testi_pad">
                                ...
                                <div class="testimonial__slider__active__3" data-aos="fade-up">
                                    ...
                                    <div class="testimonialarea__paragraph__3 ">
                                        ...
                                        <div class="testimonialarea__person__3">
                                            <div class="testimonial__img__3">
                                                <img loading="lazy" src="<?php echo e(asset('assets/img/testimonial/testi_2.png')); ?>"  alt="">
                                            </div>
                                    ...
                                    <div class="testimonialarea__paragraph__3 ">
                                        ...
                                        <div class="testimonialarea__person__3">
                                            <div class="testimonial__img__3">
                                                <img loading="lazy" src="<?php echo e(asset('assets/img/testimonial/testi_3.png')); ?>" alt="">
                                            </div>
                                            <div class="testimonial__name">
                                                <h6>Lisa Sam</h6>
                                                <span>Parent</span>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                                <div class="registerarea__form homecontact">
                                    ...
                                    <form id="contact-form" class="contact-form" action="<?php echo e(route('contact.submit')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/frontend/home.blade.php ENDPATH**/ ?>