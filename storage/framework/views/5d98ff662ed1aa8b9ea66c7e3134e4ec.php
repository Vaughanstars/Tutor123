    ...
    <body class="body__wrapper">
      ...
      <div id="back__preloader">
        ...
        <div class="back__loader_logo">
          <img loading="lazy" src="<?php echo e(asset('assets/img/pre.png')); ?>" alt="Preload">
        </div>
      </div>
      <!-- pre loader area end -->
      <main class="main_wrapper overflow-hidden">
        ...
        <header>
                  ...
                  <div class="headerarea__left">
                    ...
                    <div class="headerarea__left__logo">
                      <a href="<?php echo e(url('/')); ?>">
                        <img loading="lazy" src="<?php echo e(asset('assets/img/logo/logo.png')); ?>" alt="Tutor123 Logo" class="site-logo">
                      </a>
                    </div>
                ...
                <div class="col-xl-7 col-lg-7 main_menu_wrap">
                  <div class="headerarea__main__menu">
                    <nav>
                      <ul>
                        <li>
                          <a class="headerarea__has__dropdown <?php echo e(request()->is('/') ? 'active_menu' : ''); ?>" href="<?php echo e(url('/')); ?>">HOME
                          </a>
                        </li>
                        <li>
                          <a class="headerarea__has__dropdown <?php echo e(request()->is('about') ? 'active_menu' : ''); ?>" href="<?php echo e(url('about')); ?>">ABOUT US</a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a class="headerarea__has__dropdown <?php echo e(request()->is('contact') ? 'active_menu' : ''); ?>" href="<?php echo e(url('contact')); ?>">CONTACT</a>
                        </li>
                      </ul>
                    </nav>
                  </div>
                        ...
                        <div class="row align-items-center">
                          <div class="col-6">
                            <div class="mobile-logo">
                              <a class="logo__dark" href="<?php echo e(url('/')); ?>"><img loading="lazy"  src="<?php echo e(asset('assets/img/logo/logo.png')); ?>" alt="logo" class="site-logo"></a>
                            </div>
                          </div>
                          <div class="col-6">
                        ...
                        <div class="mobile-navigation">
                          ...
                          <nav>
                            <ul class="mobile-menu">
                              <li class="menu-item-has-children"><a href="<?php echo e(url('/')); ?>">HOME</a></li>
                              <li class="menu-item-has-children"><a href="<?php echo e(url('about')); ?>">ABOUT US</a></li>
                              ...
                              <li class="menu-item-has-children"><a href="<?php echo e(url('contact')); ?>">CONTACT</a></li>
                            </ul>
                          </nav>
          ...
          <div class="footerarea">
                ...
                <div class="row footerlogodiv">
                  <div class="col-xl-3 col-lg-3 col-md-3">
                    <div class="copyright__logo">
                      <a href="<?php echo e(url('/')); ?>"><img loading="lazy"  src="<?php echo e(asset('assets/img/logo/logo.png')); ?>" alt="logo" class="site-logo"></a>
                    </div>
                  </div>
                    ...
                    <div class="footerarea__icon ">
                      <div class="">
                            ...
                            <!-- <div class="headerarea__login">
                              ...
                              <div class="headerarea__button">
                                <a  class="footercontact" href="<?php echo e(url('contact')); ?>">CONTACT</a>
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            </html><?php /**PATH C:\xampp82\htdocs\lms\resources\views/frontend/layouts/app.blade.php ENDPATH**/ ?>