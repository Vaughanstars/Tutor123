...
<?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($footerActions) || (! \Filament\Support\is_slot_empty($footer))): ?>
                    <div
                        class="<?php echo \Illuminate\Support\Arr::toCssClasses([
...
<?php /**PATH C:\xampp82\htdocs\lms\resources\views/vendor/filament/components/modal/index.blade.php ENDPATH**/ ?>