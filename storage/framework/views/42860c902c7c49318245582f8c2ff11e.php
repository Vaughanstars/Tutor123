            ...
            <div class="col-xl-12">
                <div class="breadcrumb__content__wraper" data-aos="fade-up">
                    <div class="breadcrumb__title">
                        <h2 class="heading">Contact Tutor123</h2>
                    </div>
                    ...
                    <form id="contact-form" class="contact-form" action="<?php echo e(route('contact.submit')); ?>" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6  mb-4">
                                <div class="dashboard__select__heading">
                                    <span>Prefered Learning Format</span>
                                </div>
                                <div class="dashboard__selector">
                                    <select name="learning_format" class="form-select dark_select" aria-label="Select ">
                            ...
                            <div class="col-xl-6  mb-4">
                                <div class="dashboard__select__heading">
                                    <span>Prefered Time of Contact </span>
                                </div>
                                <div class="dashboard__selector">
                                    <select name="time_contact" class="form-select" aria-label="Select">
                            ...
                            <div class="col-xl-12" data-aos="fade-up">
                                <div class="contact__input__wraper">
                                    <textarea name="message" cols="30" rows="10" placeholder="Briefly share your child's goals,challenges,or what support you are looking for."></textarea>
                                    <div class="contact__icon">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp82\htdocs\lms\resources\views/frontend/contact.blade.php ENDPATH**/ ?>